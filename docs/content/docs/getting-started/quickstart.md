...
| --- | --- | --- |
| [phi-2](https://huggingface.co/microsoft/phi-2) | [LLM]({{%relref "docs/features/text-generation" %}}) | ```docker run -ti -p 8080:8080 -e HUGO_EXTENDED=true localai/localai:{{< version >}}-ffmpeg-core phi-2``` |
